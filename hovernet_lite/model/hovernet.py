"""
Just the orignal hovernet implementation from:
...
class HoVerNet(Net):
    ...
    def __init__(self, input_ch=3, nr_types=None, freeze=False, mode='original'):
        ...
        def create_decoder_branch(out_ch=2, ksize=5):
            ...
            u3 = nn.Sequential(OrderedDict(_module_list))
            ...
            u0 = nn.Sequential(OrderedDict(_module_list))
